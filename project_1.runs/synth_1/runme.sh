...
HD_PWD='C:/Users/vbogd/Documents/Superscalar-Risc-V/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROB.tcl
