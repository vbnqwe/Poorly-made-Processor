...
HD_PWD='C:/Users/vbogd/Documents/Superscalar-Risc-V/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source delay_test.tcl -notrace
